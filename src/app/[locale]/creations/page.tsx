...
// カテゴリー定義
const categories = [
  { id: 'all', label: 'すべて', color: 'from-cyan-500 to-blue-600' },
  { id: 'web', label: 'Webアプリ', color: 'from-blue-500 to-indigo-600' },
  { id: 'mobile', label: 'モバイルアプリ', color: 'from-indigo-500 to-purple-600' },
  { id: 'design', label: 'UIデザイン', color: 'from-purple-500 to-pink-600' },
  { id: 'game', label: 'ゲーム開発', color: 'from-rose-500 to-orange-600' },
];
      ...
      >
          ...
          {filteredProjects.map((project, index) => (
            ...
            >
              ...
              <div className="p-6 flex-grow flex flex-col">
                <h3 className="text-xl font-display mb-1 text-white">{project.title}</h3>
                <p className="text-cyan-300 text-sm mb-3">{project.subtitle}</p>
        ...
        <div className="text-center mt-12">
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
          >
            <FaCode className="mr-2" /> すべての作品を見る
          </motion.button>
        </div>
      </motion.div>
    </div>
